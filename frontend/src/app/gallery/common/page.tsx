...
export default async function CommonGalleryPage() {
  const images = await readPublicImages('common');
  return (
    <main>
      <Section title="Общие изображения" lead="Файлы из public/images/common">
        <Container>
          {images.length === 0 ? (
            <p className={styles.caption}>Пока нет изображений. Добавьте файлы в public/images/common</p>
          ) : (
